    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-fade-in relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="space-y-6">
          ...
          {/* AI Prompt Assistant Promo Card */}
          <div className="bg-dark-900 border border-dark-800 rounded-xl p-6 space-y-4 shadow-md relative overflow-hidden">
            <div className="flex items-center justify-between border-b border-dark-800 pb-3">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
                <Sparkles className="h-4.5 w-4.5 text-primary-500" />
                AI Social Assistant
              </h3>
              <span className="bg-primary-600/10 text-primary-400 border border-primary-500/20 text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-full">
                New Page
              </span>
            </div>
            
            <p className="text-xs text-dark-400 leading-relaxed leading-normal">
              Draft, customize, and publish grounded posts directly to your LinkedIn and Twitter feeds in our new dedicated workspace.
            </p>

            <Link
              to="/assistant"
              className="w-full py-2.5 bg-gradient-to-r from-primary-600 to-teal-600 hover:from-primary-500 hover:to-teal-500 text-white font-extrabold text-xs rounded-xl shadow-md transition-all cursor-pointer flex items-center justify-center gap-1.5 hover:-translate-y-0.5"
            >
