...
export default function Sidebar({ user, onLogout, isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 md:relative w-64 bg-dark-900 border-r border-dark-800 flex flex-col h-screen transition-transform duration-300 ease-in-out ${
